...
export default function Login() {
  ...
  return (
    ...
    // parent (App.jsx / #root) does with height. This is the #1 fix for
    // "background nazar nahi aa raha" issues.
    <main className="fixed inset-0 z-0 overflow-y-auto overflow-x-hidden bg-[#030814] font-sans">
      <div className="relative min-h-screen w-full px-4 py-8">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          {/* ================= PLUS SYMBOLS ================= */}
          <Plus size={14} className="absolute left-[15%] top-[20%] text-emerald-400/30" />
          <Plus size={12} className="absolute left-[28%] top-[35%] text-cyan-400/20" />
          <Plus size={14} className="absolute bottom-[25%] right-[20%] text-emerald-400/25" />
          <Plus size={12} className="absolute bottom-[18%] right-[12%] text-cyan-400/25" />
